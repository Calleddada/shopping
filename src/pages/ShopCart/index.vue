      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart) in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cart.isChecked" @change="updatedChecked(cart,$event)">
          </li>
...
import throttle from 'lodash/throttle'
  export default {
    ...
    methods:{
      ...
      async updatedChecked(cart,event){
        try {
          let isChecked = event.target.checkde ? '1':'0'
